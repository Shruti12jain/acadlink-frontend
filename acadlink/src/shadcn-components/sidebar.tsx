  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'flex h-full w-48 flex-col bg-sidebar text-sidebar-foreground 2xl:w-52 3xl:w-56',
            className
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            data-sidebar="sidebar"
            data-mobile="true"
            className="w-48 bg-sidebar p-0 text-sidebar-foreground 2xl:w-52 3xl:w-56 [&>button]:hidden"
            style={
              {
                '--sidebar-width': SIDEBAR_WIDTH_MOBILE,
              } as React.CSSProperties
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'relative h-svh w-48 bg-transparent transition-[width] duration-200 ease-linear 2xl:w-52 3xl:w-56',
            'group-data-[collapsible=offcanvas]:w-0',
            'group-data-[side=right]:rotate-180',
            variant === 'floating' || variant === 'inset'
              ? 'group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]'
        ...
        <div
          className={cn(
            'fixed inset-y-0 z-10 hidden h-svh w-48 transition-[left,right,width] duration-200 ease-linear md:flex 2xl:w-52 3xl:w-56',
            side === 'left'
              ? 'left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]'
              : 'right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]',
            // Adjust the padding for floating and inset variants.
